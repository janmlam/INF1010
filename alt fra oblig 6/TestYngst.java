//testklasse for å teste yngsteforstereseptliste sine metoder og iterering
class TestYngst {
    ...
    public static void main(String[] args) {
		...
		boolean test3 = beholder1.settInn(resept0);	
		System.out.println("Tester settInn metode. Forventer true. Resultat: "+test3);
		if(test3 != true) {
			System.out.println("Forventet verdi != resultatverdi.");
			metodeFeil++;
		}
