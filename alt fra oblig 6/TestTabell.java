//test klasse som tester ut tabell for metoder og iterering
class TestTabell {
    ...
    public static void main(String[] args) { 
		...
		System.out.println("Sjekker om det er sukesss naar man putter inn element."+
		...
		tabell1.settInn(resept1,3);
		int test3 = tabell1.finn(3).giNummer();
		System.out.println("Putter inn resept nr.1 i index 3. Tester om vi faar "+
			"samme resept nr. ved aa finne index. Forventer 1. Resultat: " + test3);
		if(test3 != 1) {
			System.out.println("Forventet verdi != resultatverdi.");
		    metodeFeil++;
		}
